...
```json
{
  "projectName" : "josh-tanzu-java-web-app",
  "repositoryPrefix" : "harbor.pks-12.slot-35.tanzu-gss-labs.vmware.com/tap/apps"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->josh-tanzu-java-web-...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor.pks-12.slot-3...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: josh-tanzu-java-we...(truncated)]
